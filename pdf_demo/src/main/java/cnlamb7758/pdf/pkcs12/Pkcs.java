...
public class Pkcs {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String issuerStr = "CN=测试证书,OU=产品研发部,O=普华诚信信息技术有限公司,C=CN,E=lamb7758@163.com,L=上海,ST=上海";
        String subjectStr = "CN=测试证书,OU=产品研发部,O=普华诚信信息技术有限公司,C=CN,E=lamb7758@163.com,L=上海,ST=上海";
        String certificateCRL  = "https://www.lamb7758.cn";
        Map<String, byte[]> result = createCert("123456", issuerStr, subjectStr, certificateCRL);

        FileOutputStream outPutStream = new FileOutputStream("c:/lamb.p12"); // ca.jks
        outPutStream.write(result.get("keyStoreData"));
        outPutStream.close();
        FileOutputStream fos = new FileOutputStream(new File("c:/lamb.cer"));
